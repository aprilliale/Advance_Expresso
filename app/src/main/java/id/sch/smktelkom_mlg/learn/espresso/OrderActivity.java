...
public class OrderActivity extends AppCompatActivity {
    public final static String EXTRA_TOTAL_PRICE = "id.sch.smktelkom_mlg.learn.espresso.EXTRA_TOTAL_PRICE";
    public final static String EXTRA_TEA_NAME = "id.sch.smktelkom_mlg.learn.espresso.EXTRA_TEA_NAME";
    public final static String EXTRA_SIZE = "id.sch.smktelkom_mlg.learn.espresso.EXTRA_SIZE";
    public final static String EXTRA_MILK_TYPE = "id.sch.smktelkom_mlg.learn.espresso.EXTRA_MILK_TYPE";
    public final static String EXTRA_SUGAR_TYPE = "id.sch.smktelkom_mlg.learn.espresso.EXTRA_SUGAR_TYPE";
    public final static String EXTRA_QUANTITY = "id.sch.smktelkom_mlg.learn.espresso.EXTRA_QUANTITY";
